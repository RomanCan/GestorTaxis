            ...
            <ul class="dropdown-menu" style="background-color: black">
              ...
              <li class="user-body">
                <div class="pull-right" >
                  <a href="{{url('logout')}}" class="btn btn-primary btn-flat" style="background-color: white">Salir</a>
                </div>
                <!-- <div class="row">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="{{url('perfil')}}"><i class="glyphicon glyphicon-book"></i><span>Perfil</span></a></li><br>

        <li class="active"><a href="{{url('pasajesfijos')}}"><i class="glyphicon glyphicon-book"></i><span>Pasajes Fijos</span></a></li>
